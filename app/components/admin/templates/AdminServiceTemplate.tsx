...
import AdminStatsCard from "@/app/components/admin/moleculs/AdminStatsCard";
import AdminBookingsTable from "@/app/components/admin/organism/AdminBookingsTable";
import type { ShuttleBookingRecordAdmin, ColumnDef } from "@/app/types/booking";
import {
  IconBookings,
  IconPending,
  IconUsers,
  IconRevenue,
} from "@/app/components/admin/atoms/AdminIcons";
...
interface AdminServiceTemplateProps {
  ...
  stats?: StatItem[];
  columns: ColumnDef[];
  bookings: ShuttleBookingRecordAdmin[];
}

function defaultStats(bookings: ShuttleBookingRecordAdmin[]): StatItem[] {
