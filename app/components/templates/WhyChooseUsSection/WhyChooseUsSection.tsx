const FEATURES = [
  ...
  },
  {
    icon: (
      <svg viewBox="0 0 40 40" fill="none" className="w-8 h-8">
        <path d="M20 6 L24 16 L36 16 L26 23 L30 34 L20 27 L10 34 L14 23 L4 16 L16 16 Z" stroke="currentColor" strokeWidth="2" fill="currentColor" opacity="0.2" />
      </svg>
    ),
    title: "Tim Profesional Berpengalaman",
    desc: "Pengemudi dan pemandu wisata kami berlisensi resmi dengan minimal 5 tahun pengalaman.",
  },
  {
    icon: (
      <svg viewBox="0 0 40 40" fill="none" className="w-8 h-8">
  ...
  },
  {
    ...
    desc: "Beroperasi di lebih dari 20 kota besar di Indonesia dengan jaringan mitra terpercaya.",
  },
  {
    icon: (
      <svg viewBox="0 0 40 40" fill="none" className="w-8 h-8">
