...
export default function ServicesSection() {
  ...
  const SERVICES = [
    ...
    },
    {
      ...
      title: t("privateCar.title"),
      desc: t("privateCar.desc"),
      href: "/private-car",
    },
    {
      slug: "ticketing",
    ...
    },
    {
      ...
      title: t("spearFishing.title"),
      desc: t("spearFishing.desc"),
      href: "/spear-fishing",
    },
    {
      slug: "travel",
  ...
  return (
    <section id="service" className="py-20 lg:py-28" style={{ background: "var(--brand-navy-950)" }}>
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-14 text-center">
          ...
          >
            {t("sectionTitle")}&nbsp;
            <span style={{ color: "var(--brand-accent-400)" }}>{t("sectionTitleHighlight")}</span>
          </h2>
          <p
