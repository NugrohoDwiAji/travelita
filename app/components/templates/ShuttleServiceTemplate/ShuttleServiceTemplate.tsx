import ShuttleBookingForm from "@/app/components/organism/ShuttleBookingForm/ShuttleBookingForm";
      ...
      >
        ...
        <div className="relative mx-auto max-w-4xl px-4 sm:px-6 text-center">
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-6">
            {[
              { value: "500+", label: "Rute Tersedia" },
              { value: "50K+", label: "Penumpang/Bulan" },
